...
ActiveRecord::Schema[7.0].define(version: 2023_01_15_144821) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["rental_request_id"], name: "index_users_on_rental_request_id"
  ...
  add_foreign_key "users", "rental_requests"
end
